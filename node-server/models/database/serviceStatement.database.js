...
const serviceStatementSequelize = new Sequelize(config.DB_SERVICE_STATEMENT, config.USER, config.PASSWORD, {
  host: config.HOST,
...
serviceStatementDB.serviceStatements = require('../serviceStatement.model.js')(serviceStatementSequelize, Sequelize)
