        ...
        <el-form :model="suicideAssessmentForm" ref="suicideAssessmentForm" class="demo-dynamic">
          <el-form-item>
            <el-checkbox-group v-model="checkboxSuicideAssessment">
              ...
              -->
              <el-checkbox-button v-for="app in suicideAssessment" :label="app" :key="app">{{app}}</el-checkbox-button>
            </el-checkbox-group>
...
<script>
const suicideAssessmentOptions = ["Does patient report suicidal ideations ?"];
