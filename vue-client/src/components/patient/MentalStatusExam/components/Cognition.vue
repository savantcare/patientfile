<template>
  <div>
    <el-card class="box-card">
      ...
      <el-form :model="cognitionForm" ref="cognitionForm" class="demo-dynamic">
        <el-form-item>
          <el-checkbox-group v-model="checkboxCognition">
        ...
        <el-form-item>
          ...
          -->
          <el-button type="success" @click="submitForm('cognitionForm')" size="small">Save</el-button>
        </el-form-item>
      </el-form>
    </el-card>
  </div>
...
export default {
  data() {
    return {
      cognitionForm: { recs: [{ description: "" }] },
