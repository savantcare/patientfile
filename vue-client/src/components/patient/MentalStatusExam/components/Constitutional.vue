  ...
  <div>
    <el-col>
      <el-card class="box-card">
        ...
        <el-form :model="consitutionalForm" ref="consitutionalForm" class="demo-dynamic">
          <el-form-item>
            <el-checkbox-group v-model="checkboxConsitutional">
          ...
          <el-form-item>
            ...
            -->
            <el-button type="success" @click="submitForm('consitutionalForm')" size="small">Save</el-button>
          </el-form-item>
        </el-form>
      </el-card>
    </el-col>
