...
CREATE TABLE `cognition` (
  `patientUUID` varchar(36) NOT NULL,
  `grossly-intact-no-memory-impairment-adequate-fund-of-knowledge-n` ENUM('yes','no') NOT NULL DEFAULT 'no',
...
CREATE TABLE `perception` (
  `patientUUID` varchar(36) NOT NULL,
  `no-avh` ENUM('yes','no') NOT NULL DEFAULT 'no',
  `ah` ENUM('yes','no') NOT NULL DEFAULT 'no',
  `command-ah` ENUM('yes','no') NOT NULL DEFAULT 'no',
  `vh` ENUM('yes','no') NOT NULL DEFAULT 'no',
  `other` text NOT NULL,
  `recordChangedByUUID` varchar(36) NOT NULL,
  `recordChangedFromIPAddress` varchar(20) NOT NULL,
  PRIMARY KEY (`patientUUID`)
...
CREATE TABLE `thaught-content` (
  `patientUUID` varchar(36) NOT NULL,
  `no-si-intent-or-plan` ENUM('yes','no') NOT NULL DEFAULT 'no',
  `no-passive-death-wish` ENUM('yes','no') NOT NULL DEFAULT 'no',
  `no-hi-intent-or-plan` ENUM('yes','no') NOT NULL DEFAULT 'no',
  `no-delusional-thinking-observed` ENUM('yes','no') NOT NULL DEFAULT 'no',
  `no-obsessive-thinking-observed` ENUM('yes','no') NOT NULL DEFAULT 'no',
  `ruminations` ENUM('yes','no') NOT NULL DEFAULT 'no',
  `si-without-intent-or-plan` ENUM('yes','no') NOT NULL DEFAULT 'no',
  `si-as-detailed-below` ENUM('yes','no') NOT NULL DEFAULT 'no',
  `hi-as-detailed-below` ENUM('yes','no') NOT NULL DEFAULT 'no',
  `delusions` ENUM('yes','no') NOT NULL DEFAULT 'no',
  `ior` ENUM('yes','no') NOT NULL DEFAULT 'no',
  `obsessions` ENUM('yes','no') NOT NULL DEFAULT 'no',
  `passive-death-wish` ENUM('yes','no') NOT NULL DEFAULT 'no',
  `other` text NOT NULL,
  `recordChangedByUUID` varchar(36) NOT NULL,
  `recordChangedFromIPAddress` varchar(20) NOT NULL,
  PRIMARY KEY (`patientUUID`)
