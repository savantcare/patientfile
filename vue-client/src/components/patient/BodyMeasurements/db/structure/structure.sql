...
(11) NOT NULL,
  `relationToMeal` enum
('Before breakfast','After breakfast','Before lunch','After lunch','Before dinner','After dinner','Bed time','Other') NOT NULL,
  `timeOfEvaluation` date NOT NULL,
  `Notes` text DEFAULT NULL,
  `recordChangedByUUID` varchar
(36) DEFAULT NULL,
...
(
  `patientUUID` varchar
(36) DEFAULT NULL,
  `temperatureInFarehnite` decimal
(10,0) NOT NULL,
  `timeOfEvaluation` date NOT NULL,
  `Notes` text DEFAULT NULL,
  `recordChangedByUUID` varchar
...
(
  `patientUUID` varchar
(36) NOT NULL,
  `waistCircumferenceInInches` decimal
(10,2) NOT NULL,
  `timeOfEvaluation` date NOT NULL,
  `Notes` text DEFAULT NULL,
  `recordChangedByUUID` varchar
